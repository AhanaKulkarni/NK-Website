...
export const metadata = {
  title: 'Best SSC Coaching Classes Borivali West | NK Academy',
  description: 'Unlock your academic potential with the Best SSC Coaching Classes Borivali West at NK Academy.',
};
    ...
    <div className={styles.page}>
      <div className={styles.header}>
        <div className="container" style={{ textAlign: 'center' }}>
          <h1 className={styles.title} style={{ fontSize: '3.5rem', marginBottom: '0.5rem' }}>Best SSC Coaching Classes Borivali West</h1>
          <p className={styles.subtitle}>
            Home » <span style={{ color: 'var(--color-accent)' }}>Best SSC Coaching Classes Borivali West</span>
          </p>
        </div>
      </div>
      ...
      <div className="container" style={{ padding: '4rem 0', maxWidth: '900px' }}>
        <h2 style={{ color: 'var(--color-primary)', textAlign: 'center', fontSize: '2.5rem', marginBottom: '2rem' }}>
          Unlock Your Academic Potential with the Best SSC Coaching Classes Borivali West in Borivali West
        </h2>
        
        <p style={{ color: 'var(--color-supporting)', fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '2rem' }}>
          If you are looking for the Best SSC Coaching Classes Borivali West in Borivali West, NK Academy is your ideal destination. With a focus on providing quality education, NK Academy offers a nurturing environment for students aiming to excel in the Maharashtra State Board syllabus. The academy's experienced faculty, structured courses, and personalized attention ensure that students are well-prepared to face the challenges ahead.
        </p>

        <h3 style={{ color: 'var(--color-primary)', fontSize: '2rem', marginBottom: '1.5rem', marginTop: '3rem' }}>
          Why Choose NK Academy for SSC Coaching?
        </h3>
